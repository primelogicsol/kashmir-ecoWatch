...
const regex = /<Card className="glass-intense border-white\/10 p-6" padding="none">[\s\S]*?<\/Card>/;

const newKpiBlock = `<Card className="glass-intense border-white/10 p-4 lg:p-5" padding="none">
...
code = code.replace(regex, newKpiBlock);
