...
export default function BirdMortalityKillMonitoringPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">{/* Hero Section */}
      <Heading
        breadcrumbs={[{ label: 'Risk & Monitoring', href: '/risk-monitoring' }, { label: 'Biodiversity Risks', href: '/risk-monitoring/biodiversity-risks' }, { label: 'Bird Mortality / Kill Monitoring' }]}
        title={<><span className="block whitespace-nowrap">Bird Mortality /</span><span className="block whitespace-nowrap bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent">Kill Monitoring</span></>}
        subtitle="Wetland bird mortality tracking, collision and habitat pressure deaths, poisoning/contamination events, disease clusters, and seasonal bird kill anomaly detection"
        icon={<Bird className="w-6 h-6 text-emerald-400" />}
        label="Avian Mortality Intelligence"
        actions={
