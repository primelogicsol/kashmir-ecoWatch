  ...
  return (
    <main className="min-h-screen bg-slate-950">
      <Heading
        ...
        title={<>Ecosystem Stress <span className="text-emerald-400">& Mortality Signals</span></>}
        ...
        icon={
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-red-500 to-amber-600 flex items-center justify-center shadow-2xl">
            <Activity className="w-5 h-5 md:w-8 md:h-8 text-white" />
          </div>
        }
        badge={<Badge variant="danger" size="lg">Ecosystem Health Intelligence</Badge>}
        actions={
