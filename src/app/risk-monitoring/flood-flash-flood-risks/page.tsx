  ...
  return (
    <main className="min-h-screen bg-slate-950">
      <Heading
        ...
        title={<>Flood & <span className="text-emerald-400">Flash Flood Risks</span></>}
        subtitle="River flooding, flash flood corridors, and GLOF risk monitoring"
        icon={
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center shadow-2xl"><Droplets className="w-5 h-5 md:w-8 md:h-8 text-white" /></div>
        }
        badge={<Badge variant="info" size="lg">Water Hazards</Badge>}
        actions={
